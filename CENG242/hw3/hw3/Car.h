...
private:
    ...
    Laptime fastest_laptime;
    Laptime latest_laptime;
...
public:
    ...
    int LapAdder();
    Laptime *getHeadLap() const;
    Car *getNextCar() const;

    void setName(std::string name);
    void setPerformance(double performance);
    void setNext(const Car& next);
    void setNextCar(Car *next);
    void setLap(Laptime* head);

    Laptime* findFastest() const;
    Laptime* findLatest() const;

    Laptime getTotal() const;
    Laptime getFastest() const;
    Laptime getLatest() const;

    void setTotal(const Laptime total);
    void setFastest(const Laptime fastest);
    void setLatest(const Laptime latest);

    void oneLapRemover();
    void deleteLaps();

    int lapNoCounter() const;
