...
public:
    ...
    public:
        ...
        void timed_wait(int time_out_microseconds){                                                         
            struct timespec wait_time = {0,0};
            long time_out_nanoseconds = time_out_microseconds * 1000;
            
            clock_gettime(CLOCK_REALTIME, &wait_time);
            wait_time.tv_nsec += time_out_nanoseconds;

            pthread_cond_timedwait(&cond, &owner->mut, &wait_time);
