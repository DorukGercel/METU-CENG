...
namespace fst
{
    ...
    public:
        ...
        math::Vector3f computeBrdf(const math::Vector3f& wi, const math::Vector3f& wo, const math::Vector3f& normal, const math::Vector3f& textConstant, int statusCode) const;
