...
namespace fst
{
    Mesh::Mesh(const std::vector<Triangle>& triangles, int material_id, int texture_id ,math::Vector4f* transformationMatrix)
    ...
    Mesh::Mesh(std::vector<Triangle>&& triangles, int material_id, int texture_id ,math::Vector4f* transformationMatrix)
