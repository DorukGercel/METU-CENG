...
namespace fst
{
    Triangle::Triangle(const math::Vector3f& v0, const math::Vector3f& edge1, const math::Vector3f& edge2, const math::Vector2f& coord1, const math::Vector2f& coord2,const math::Vector2f& coord3)
        : m_v0(v0)
        , m_edge1(edge1)
        , m_edge2(edge2)
